        ...
        <div className="px-8 pt-10 pb-8 space-y-6">
          ...
          {sent ? (
            <div className="space-y-4">
              <div className="text-sm text-center bg-quaternary/10 px-4 py-4 rounded-xl border-2 border-quaternary/30 space-y-1">
                <p className="font-heading font-bold text-quaternary">Confirmation email sent!</p>
                <p className="text-muted-foreground">Click the link in your email to activate your account.</p>
              </div>
              <p className="text-center text-sm text-muted-foreground">
                Already confirmed?{' '}
                <Link href="/login" className="font-bold text-foreground underline underline-offset-2 hover:text-primary transition-colors">
                  Sign in
                </Link>
              </p>
            </div>
